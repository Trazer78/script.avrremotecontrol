...
'''
    ...
    avr_x2000.py --> Denon AVR-X2000 implementation
'''
import ast
import os
from resources.lib.utils import log_msg, telnet_execute, get_addon_path

class DenonAVRX2000(object):
    ''' Denon AVR-X2000 implementation '''
    ...
    def get_commandlist(self):
        ...
        # Load commands list
        # commandfile = os.path.join(get_addon_path(), 'resources/lib/devices/denon/avr_x2000.codes')
